...
- Current branch observed: `feature/react-migration`
- Existing GitHub issues observed: none
- Existing labels observed: GitHub defaults only
- Local repo was dirty before this migration slice. The migration must not reset, overwrite, or stage unrelated user/agent work.
